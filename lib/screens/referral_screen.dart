                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Expanded(child: _statBox('Points gagnés', '${auth.referralCount * 5} pts', Icons.stars_rounded, AppColors.green)),
                    ],
                  ),
                  const SizedBox(height: 24),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _infoRow('3.', 'Tu gagnes 5 points par ami inscrit'),
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text('+5 pts', style: TextStyle(color: AppColors.green, fontSize: 12, fontWeight: FontWeight.w600)),
                          ),
                        ],
                      ),
                    )),
