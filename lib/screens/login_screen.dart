        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text('RecycPay', style: Theme.of(context).textTheme.headlineLarge?.copyWith(fontSize: 26)),
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(url, fit: BoxFit.cover, errorBuilder: (_, __, ___) => const Icon(Icons.person, color: AppColors.grey)),
                        ),
                      ),
                    );
                  },
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: selected ? AppColors.green : AppColors.glassBorder,
                              width: 1.5,
                            ),
                          ),
                          child: Column(
              ...
              Text('Nom d\'utilisateur', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 14)),
              const SizedBox(height: 8),
              TextField(
              ...
              Text('Mot de passe', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontSize: 14)),
              const SizedBox(height: 8),
              TextField(
